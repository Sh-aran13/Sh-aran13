...
<svg width="100%" viewBox="0 0 680 220" role="img" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    ...
    <linearGradient id="waveLine" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="30%" stop-color="#58A6FF" stop-opacity="0.6"/>
      <stop offset="70%" stop-color="#3B82F6" stop-opacity="0.6"/>
      <stop offset="100%" stop-color="#3B82F6" stop-opacity="0"/>
    </linearGradient>
  </defs>
  <rect width="680" height="220" fill="url(#bg)"/>
  <path d="M0,0 Q170,40 340,20 Q510,0 680,30 L680,0 Z" fill="#131d2e" opacity="0.8"/>
  <path d="M0,220 Q170,180 340,200 Q510,220 680,190 L680,220 Z" fill="#131d2e" opacity="0.8"/>
  <circle cx="40" cy="30" r="1" fill="#58A6FF" opacity="0.7"/>
  <circle cx="120" cy="15" r="1.5" fill="#fff" opacity="0.4"/>
  <circle cx="220" cy="40" r="1" fill="#58A6FF" opacity="0.5"/>
  <circle cx="300" cy="12" r="1" fill="#fff" opacity="0.3"/>
  <circle cx="420" cy="25" r="1.5" fill="#58A6FF" opacity="0.6"/>
  <circle cx="530" cy="10" r="1" fill="#fff" opacity="0.4"/>
  <circle cx="620" cy="35" r="1" fill="#58A6FF" opacity="0.5"/>
  <circle cx="660" cy="18" r="1.5" fill="#fff" opacity="0.3"/>
  <circle cx="80" cy="185" r="1" fill="#58A6FF" opacity="0.5"/>
  <circle cx="170" cy="200" r="1.5" fill="#fff" opacity="0.3"/>
  <circle cx="460" cy="195" r="1" fill="#58A6FF" opacity="0.4"/>
  <circle cx="580" cy="210" r="1.5" fill="#fff" opacity="0.5"/>
  <circle cx="640" cy="190" r="1" fill="#58A6FF" opacity="0.6"/>
  <rect x="0" y="108" width="680" height="1" fill="url(#waveLine)" opacity="0.4"/>
  <path d="M52,72 L40,72 L40,148 L52,148" fill="none" stroke="#58A6FF" stroke-width="1.5" stroke-opacity="0.5"/>
  <path d="M628,72 L640,72 L640,148 L628,148" fill="none" stroke="#58A6FF" stroke-width="1.5" stroke-opacity="0.5"/>
  <text x="340" y="80" text-anchor="middle" font-family="'JetBrains Mono', 'Courier New', monospace" font-size="12" fill="#3B82F6" opacity="0.8" letter-spacing="3">// Full Stack Engineer</text>
  <text x="340" y="125" text-anchor="middle" font-family="'Segoe UI', Arial, sans-serif" font-size="36" font-weight="700" fill="#ffffff" letter-spacing="1">Allada Sai Satya Sharan</text>
  <rect x="200" y="133" width="280" height="2" rx="1" fill="url(#accent)" opacity="0.9"/>
  <text x="340" y="163" text-anchor="middle" font-family="'Segoe UI', Arial, sans-serif" font-size="13" letter-spacing="1">
    <tspan fill="#58A6FF">Django</tspan>
    <tspan fill="#8B949E">  ·  </tspan>
    <tspan fill="#7ee787">React.js</tspan>
    <tspan fill="#8B949E">  ·  </tspan>
    <tspan fill="#d2a8ff">PostgreSQL</tspan>
    <tspan fill="#8B949E">  ·  </tspan>
    <tspan fill="#ffa657">Machine Learning</tspan>
  </text>
  <text x="340" y="190" text-anchor="middle" font-family="'JetBrains Mono', 'Courier New', monospace" font-size="11" fill="#8B949E" letter-spacing="2" opacity="0.7">JNTU–Gurajada · Final Year B.Tech · GATE CSE 2027</text>
  <circle cx="40" cy="72" r="3" fill="#58A6FF" opacity="0.6"/>
  <circle cx="40" cy="148" r="3" fill="#58A6FF" opacity="0.6"/>
